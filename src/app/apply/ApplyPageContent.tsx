    ...
    <div className="max-w-7xl mx-auto px-4 text-center">
      ...
      <div className="border-t border-gray-700 pt-4">
        <p className="text-sm text-gray-400">
          Demo Application • Powered by OpenAI Realtime API • Next.js 15
        </p>
      </div>
    </div>
  </footer>
    ...
    <div className="max-w-7xl mx-auto flex justify-between items-center">
      <div className="flex items-center gap-3">
        <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
          ...
          <div>
            <h1 className="text-2xl font-bold">Voice-Assisted Application</h1>
            <p className="text-sm text-blue-100">Speak to fill the form</p>
          </div>
        </Link>
      </div>
...
export default function ApplyPageContent() {
  ...
  const [, setShowSubmissionPopup] = useState(false);
